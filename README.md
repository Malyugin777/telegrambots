...
| **YouTube Full** | Полные видео (адаптивное 720p/480p по длительности, отправка как документ >50MB) | RapidAPI | 2GB |
...
- ✅ RapidAPI fallback при сбое yt-dlp (YouTube/TikTok/Pinterest)
