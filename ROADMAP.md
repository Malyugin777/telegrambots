...
## Текущий статус: Фаза 2.5 ЗАВЕРШЕНА
...
### 3.1 Видео Aspect Ratio (ГОТОВО)
- [x] Проверка SAR через ffprobe
- [x] Если SAR=1:1 — копируем без перекодирования
- [x] Если SAR≠1:1 — scale=iw*sar:ih,setsar=1:1
- [x] Исправлено в rapidapi_downloader.py и downloader.py

### 3.2 Страница ошибок /errors
- [ ] Таблица ошибок с фильтрами
- [ ] Статистика: всего, сегодня, по платформам
- [ ] Модель ErrorLog в БД (или использовать ActionLog с action='error')
...
|-----------|--------|-----------|-------|
| 1 | Деплой фикса видео на Hostkey | Низкая | 10 мин |
| 2 | Billing Tracker | Средняя | 2-3 сессии |
| 3 | Bot Customization | Средняя | 2-3 сессии |
| 4 | Performance Monitor | Средняя | 1-2 сессии |
| 5 | VPN Bot | Высокая | Отдельный проект |
