...
""".strip(),
    ...
    "error_too_large": "📦 Файл слишком большой (>2GB). Telegram не позволяет.",
    "error_unknown": "❌ Произошла ошибка. Попробуй позже.",
    "error_unavailable": "❌ Видео недоступно (удалено или скрыто).",
    "error_region": "🌍 Видео недоступно в этом регионе.",
    "error_api": "⚠️ Ошибка API сервиса. Попробуй позже.",
    "error_connection": "📡 Проблема с соединением. Попробуй позже.",
    "error_processing": "⚙️ Не удалось обработать видео.",
    "error_upload": "📤 Не удалось отправить файл в Telegram.",
    "error_transport": "📡 Telegram разорвал соединение при загрузке. Попробуй еще раз.",
    "error_invalid_url": """
